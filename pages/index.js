...
export default function Home() {
  ...
  return (
    <div style={{
      ...
      color: '#334155', // Colore del testo scuro per contrasto
    }}>
      <Head>
      ...
      <main style={{
        ...
        maxWidth: '600px',
        width: '100%',
        backgroundColor: 'rgba(255, 255, 255, 0.8)', // Sfondo semitrasparente chiaro
        borderRadius: '12px',
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              color: '#ffffff',
              backgroundColor: isLoading ? '#cbd5e1' : '#4f46e5', // Un blu elegante per il pulsante
              border: 'none',
              borderRadius: '8px',
