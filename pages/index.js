...
const translations = {
  it: {
    title: "GC - Genera Post Professionali",
    description: "Inserisci una descrizione di un'immagine e lascia che GC generi didascalie creative e professionali per te.",
  ...
  en: {
    title: "GC - Generate Captions",
    description: "Enter a description of an image and let GC generate creative captions for you.",
  ...
  es: {
    title: "GC - Generador de Subtítulos",
    description: "Ingresa una descripción de una imagen y deja que GC genere subtítulos creativos para ti.",
  ...
  de: {
    title: "GC - Untertitel-Generator",
    description: "Gib eine Bildbeschreibung ein und lass GC kreative Untertitel für dich erstellen.",
  ...
  fr: {
    title: "GC - Générateur de Légendes",
    description: "Saisis une description d'image et laisse GC générer des légendes créatives pour toi.",
  ...
  ru: {
    title: "GC - Генератор подписей",
    description: "Введите описание изображения, и пусть GC сгенерирует для вас креативные подписи.",
  ...
  zh: {
    title: "GC - 标题生成器",
    description: "输入图片描述，让 GC 为你生成创意标题。",
  ...
  ja: {
    title: "GC - キャプションジェネレーター",
    description: "画像の説明を入力すると、GC が創造的なキャプションを生成します。",
  ...
  ko: {
    title: "GC - 캡션 생성기",
    description: "이미지 설명을 입력하면 GC 가 창의적인 캡션을 생성해 드립니다.",
  ...
  ar: {
    title: "GC - مولد التسميات التوضيحية",
    description: "أدخل وصفًا لصورة ودع GC يولد لك تسميات توضيحية إبداعية.",
